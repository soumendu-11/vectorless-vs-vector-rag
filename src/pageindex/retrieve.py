...
try:
    from .utils import get_number_of_pages, remove_fields, _get_docling_doc, _docling_page_text
except ImportError:
    from utils import get_number_of_pages, remove_fields, _get_docling_doc, _docling_page_text
